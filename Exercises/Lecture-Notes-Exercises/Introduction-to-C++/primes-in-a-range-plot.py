...
filename = "primes-between[2-200].txt" 
...
plt.title(f"Distribución de Números Primos en el Rango [{prime_values.min()}-{prime_values.max()}]")
plt.xlabel("Índice del Primo (n)")
plt.ylabel("Valor del Primo")
...
print(f"Gráfico guardado como 'primes_plot.png'")